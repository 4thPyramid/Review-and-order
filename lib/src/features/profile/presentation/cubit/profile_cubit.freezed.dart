...
class __$$LoadLoadingImplCopyWithImpl<T, $Res>
    extends _$ProfileStateCopyWithImpl<T, $Res, _$LoadLoadingImpl<T>>
...
abstract class _LoadLoading<T> implements ProfileState<T> {
...
abstract class _Success<T> implements ProfileState<T> {
...
abstract class _Error<T> implements ProfileState<T> {
